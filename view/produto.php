        ...
        <ul class="sidebar-nav" data-coreui="navigation" data-simplebar="">
            ...
            <li class="nav-group">
                ...
                <ul class="nav-group-items">
                    <li class="nav-item">
                        <a class="nav-link" href="https://coreui.io/demo/4.0/free/base/accordion.html"><span class="nav-icon"></span> Cadastros de Produtos</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="https://coreui.io/demo/4.0/free/base/breadcrumb.html"><span class="nav-icon"></span> Produtos Cadastrados</a>
                    </li>
                </ul>
            </li>
            <li class="nav-group">
                ...
                <ul class="nav-group-items">
                <li class="nav-item">
                        <a class="nav-link" href="https://coreui.io/demo/4.0/free/base/accordion.html"><span class="nav-icon"></span> Cadastros de Usuarios</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="https://coreui.io/demo/4.0/free/base/breadcrumb.html"><span class="nav-icon"></span> Usuarios Cadastrados</a>
                    </li>
                </ul>
            </li>
            <!-- <li class="nav-group">
