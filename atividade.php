...
<html lang="pt-br">
  <head>
    ...
    <link
      href="https://getbootstrap.com/docs/5.2/examples/carousel/carousel.css"
      rel="stylesheet"
    />
  </head>
  <body>
        ...
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav me-auto mb-2 mb-md-0">
              <li class="nav-item">
                <a class="nav-link active opa" aria-current="page" href="#"
                  >Home</a
                >
              </li>
              <li class="nav-item">
    ...
    <main>
      ...
      >
        ...
        <div class="carousel-inner">
          <div class="carousel-item active">
            <img
              src="https://www.theodorahome.com.br/lojas/00019925/images/principal-1.jpg?cccfc=2a159e7d"
              class="d-block w-100"
              alt="..."
            />
          </div>
          <div class="carousel-item">
            <img
              src="https://www.theodorahome.com.br/lojas/00019925/images/principal-2.jpg?cccfc=2a0b8e14"
              class="d-block w-100"
              alt="..."
            />
          </div>
          <div class="carousel-item">
            <img
              src="https://www.theodorahome.com.br/lojas/00019925/images/principal-3.jpg?cccfc=2a0b8e27"
              class="d-block w-100"
              alt="..."
            />
          </div>
      ...
      <div class="container marketing">
        <div class="row">
          <div class="col-lg-4">
            <img
              alt="Oferta em Porta Retratos Varios Modelos"
              src="https://m.media-amazon.com/images/I/51gNf6GzazL._AC._SR360,460.jpg"
              class="octopus-pc-item-image octopus-pc-item-image-v3 redendo"
              data-a-hires="https://m.media-amazon.com/images/I/51gNf6GzazL._AC._SR360,460.jpg"
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5">
            <img
              loading="lazy"
              alt="Series 7"
              class="w-100 h-100 dn absolute top-0 left-0 z-999 vtex-product-summary-2-x-image vtex-product-summary-2-x-image--hover vtex-product-summary-2-x-imageNormal vtex-product-summary-2-x-hoverImage vtex-render-runtime-8-x-lazyload ls-is-cached lazyloaded"
              crossorigin="anonymous"
              data-src="https://wtcmktplace.vtexassets.com/arquivos/ids/156320-300-300?v=637860763408800000&amp;width=400&amp;height=400&amp;aspect=true"
              style="
                width: 400px;
                height: 400px;
                object-fit: contain;
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5 order-md-1">
            <img
              src="https://m.media-amazon.com/images/I/71f4zceJOiL._AC_SL1000_.jpg"
              class="fullscreen"
              style="
                margin-top: 93.5px;
                margin-left: 0px;
        ...
        <div class="row featurette">
          ...
          <div class="col-md-5">
            <img
              src="https://m.media-amazon.com/images/I/51AXbAW30aL._AC_.jpg"
              class="fullscreen"
              style="
                margin-top: 139px;
                margin-left: 59px;
